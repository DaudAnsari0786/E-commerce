          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <motion.div variants={fadeInUp}>
              ...
              <div className="relative group">
                <FaUser className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 transition-colors duration-300 ease-in group-focus-within:text-indigo-600" />
                <input
                  id="name"
                  name="name"
                  type="text"
